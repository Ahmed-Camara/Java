...
* The iterable interface returns an instance of Iterator which provides access to the next() method to access elements in the collection, the hasNext() method to check whether there are more elements in the iterator, and the remove() method to remove the last element returned by the iterator.
* */
